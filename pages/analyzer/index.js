...
Page({
  ...
  drawCurve(ctx, values, offsets, startHz, binSpacingHz, projectX, projectY, plotWidth, color, dashed) {
  ...
  drawSpectrum(metrics, onComplete) {
    ...
    const autoRange = spectrumRange([{ values, offsets: liveOffsets }, this.referenceSpectrum && { values: this.referenceSpectrum.values, offsets: referenceOffsets }])
    ...
    if (values.length || this.referenceSpectrum) {
      ...
      if (this.referenceSpectrum) this.drawCurve(ctx, this.referenceSpectrum.values, referenceOffsets, this.referenceSpectrum.startHz, this.referenceSpectrum.binSpacingHz, projectX, projectY, plotWidth, '#e28a43', true)
      this.drawCurve(ctx, values, liveOffsets, metrics.spectrumStartHz || 20, metrics.binSpacingHz || 1, projectX, projectY, plotWidth, '#6772dc', false)
      ctx.restore()
    }
